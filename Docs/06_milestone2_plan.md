...
## 3. Data inventory and the synthetic↔real feature gap
...
Everything below is in `Scripts/MS2/`, runs on the data already present, and is sklearn-only except the optional deep module.
